    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>
                    Este é o seu onboarding, aqui você pode nos contar um pouco mais sobre você, para que possamos te ajudar
                    melhor.
                </p>
                <p>
                ...
                <div class="card mb-3">
                    <div class="row g-0">
                        ...
                        <div class="col">
                            ...
                            <div class="card-body">
                                <a href="https://github.com/{{ $user->github_username }}" target="_blank" class="btn btn-primary">
            ...
            <div class="card-body">
                <form action="{{ route('onboarding.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="based_in" name="based_in" required>
                            @foreach(\App\Enums\BasedPlaceEnum::cases() as $base)
                                <option value="{{ $base->value }}">{{ str($base->name)->replace('_', ' ')->lower()->ucfirst() }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="pronouns" name="pronouns" required>
                            @foreach(\App\Enums\PronoumEnum::cases() as $base)
                                <option value="{{ $base->value }}">{{ str($base->name)->replace('_', '/')->lower() }}</option>
                            @endforeach
                        </select>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3" bis_skin_checked="1">
                                    ...
                                    <input type="text" class="form-control" id="twitter_handle" placeholder="danielhe4rt" name="twitter_handle">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            ...
                            <div class="input-group mb-3" bis_skin_checked="1">
                                ...
                                <input type="text" class="form-control" id="devto_handle" placeholder="danielhe4rt" name="devto_handle">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <i class="form-text text-muted">Nos conte um pouco mais sobre você, o que você busca e o que você
                            precisa.</i>
                    </div>
                    <!-- Company -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="is_employed" name="is_employed">
                        <label class="form-check-label" for="is_employed">Atualmente empregado</label>
                    </div>

                    <!-- Switching Careers? (Checkbox) -->
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="switching_careers" name="switching_careers">
